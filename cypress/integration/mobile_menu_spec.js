...
describe('Mobile Menu - Core Functionality', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('Mobile Menu - Breakpoint Transitions', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('Mobile Menu - Responsive Width', () => {
  beforeEach(() => {
    cy.visit('/');
  });
...
describe('Mobile Menu - Navigation Links', () => {
  ...
  it('should highlight current page in mobile menu', () => {
    ...
    cy.get('#mobile-menu').contains('Boutique').parent().should('have.class', 'bg-olive-700');
  });
...
describe('Mobile Menu - Scrolling Behavior', () => {
  beforeEach(() => {
    cy.visit('/');
    cy.viewport(VIEWPORTS.mobileMedium.width, VIEWPORTS.mobileMedium.height);
  });
...
describe('Mobile Menu - Accessibility', () => {
  ...
  it('should update aria-expanded when menu is opened', () => {
    ...
    cy.get('header [aria-label="Fermer le menu"]')
  ...
  it('should have focusable elements with correct tabIndex', () => {
    ...
    cy.get('#mobile-menu [aria-label="Fermer le menu"]')
      .should('have.attr', 'tabIndex', '0');
  });
});

describe('Mobile Menu - Animation & Transitions', () => {
  beforeEach(() => {
    cy.visit('/');
    cy.viewport(VIEWPORTS.mobileMedium.width, VIEWPORTS.mobileMedium.height);
  });
...
describe('Mobile Menu - Cross-Viewport Testing', () => {
