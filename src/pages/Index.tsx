    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="container mx-auto px-4 py-6 md:py-12 lg:py-24 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          {/* Left: Copy and CTA */}
          <div className="lg:w-1/2 w-full text-center lg:text-left space-y-6 hero-text-animation">
            <Badge className="inline-flex items-center mb-4 bg-olive-100 text-olive-800 hover:bg-olive-200 border-none animate-scale-in hover-glow px-3 py-2">
              <span className="w-2 h-2 bg-olive-500 rounded-full mr-2"></span>
              Artisanat Durable & Fait Main
            </Badge>
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif font-medium text-stone-800 animate-fade-in-up leading-tight">
              Créé avec amour dans les <span className="text-olive-700">montagnes du Rif</span>
            </h1>
            <p className="text-base md:text-lg lg:text-xl text-stone-600 animate-fade-in-up leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ animationDelay: '0.3s' }}>
