        ...
        <div className="bg-card rounded-lg shadow p-6 max-w-2xl mx-auto border border-border">
          ...
          <ul className="list-disc pl-6 text-muted-foreground mb-6">
            <li>
              ...
              <span className="font-medium text-primary">{t("pages:shipping.delays.standardPrice")}</span>
            </li>
            <li>
              {t("pages:shipping.delays.express")}{" "}
              <span className="font-medium text-primary">{t("pages:shipping.delays.expressPrice")}</span>
            </li>
            <li>
              {t("pages:shipping.delays.freeFrom")} <span className="font-medium text-primary">{t("pages:shipping.delays.freeThreshold")}</span>{" "}
