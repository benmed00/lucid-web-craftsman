...
const products = [
  {
    ...
    details: "Dimensions: 30 x 25 x 12 cm<br>Matériau: Fibres végétales et laine<br>Doublure intérieure en coton<br>Fermeture par bouton magnétique<br>Une poche intérieure",
    ...
    artisanStory: "Fatima vit dans un petit village des montagnes du Rif où elle a appris l'art du tissage de sa grand-mère dès l'âge de 12 ans. Elle consacre environ 18 heures à la création de chaque sac.",
    related: [2, 3, 6]
  },
  {
    id: 2,
    ...
    price: 45,
    images: [
      "https://images.unsplash.com/photo-1577890911494-ccbc085198b7?ixlib=rb-4.0.3&auto=format&fit=crop&w=640&q=80"
    ],
    category: "Chapeaux",
    ...
    details: "Taille ajustable<br>Matériau: Fibres de palmier nain<br>Ruban décoratif en coton tissé",
  ...
  },
  {
    ...
    category: "Sacs",
    description: "Cette pochette brodée à la main présente des motifs traditionnels berbères réalisés avec des fils colorés sur une base de tissu robuste.",
    details: "Dimensions: 25 x 15 cm<br>Matériau: Coton et fils de soie<br>Fermeture éclair",
  ...
  },
  {
    ...
    category: "Sacs",
    description: "Ce panier de marché traditionnel est parfait pour les courses quotidiennes, alliant fonctionnalité et esthétique artisanale.",
    details: "Dimensions: 40 x 30 x 20 cm<br>Matériau: Osier et cuir<br>Poignées en cuir véritable",
...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    if (foundProduct && foundProduct.related) {
      const related = products.filter(p => foundProduct.related.includes(p.id));
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="mt-4 mb-8 text-stone-600">Le produit que vous recherchez n'existe pas.</p>
          <Link to="/products">
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="text-sm text-stone-500">
          <Link to="/" className="hover:text-olive-700">Accueil</Link>
          <span className="mx-2">/</span>
          <Link to="/products" className="hover:text-olive-700">Boutique</Link>
          <span className="mx-2">/</span>
                ...
                {product.images.map((image: string, idx: number) => (
                  <div 
                    ...
                    className={`aspect-ratio aspect-w-1 aspect-h-1 rounded-md overflow-hidden cursor-pointer border-2 
                      ${selectedImage === idx ? 'border-olive-500' : 'border-transparent'}`}
          ...
          <div>
            ...
            <div className="bg-beige-50 p-4 rounded-lg mb-8">
              <div className="flex items-center mb-2">
                ...
                <h3 className="font-medium">Fait à la main par {product.artisan}</h3>
              </div>
            ...
            <Tabs defaultValue="details" className="mt-8">
              ...
              <TabsContent value="details" className="mt-4">
                <div className="text-stone-600 text-sm space-y-2" dangerouslySetInnerHTML={{ __html: product.details.replace(/<br>/g, '<br class="block mb-2">') }} />
              </TabsContent>
              <TabsContent value="dimensions" className="mt-4">
                <div className="text-stone-600 text-sm">
                  Veuillez consulter les informations détaillées pour les dimensions spécifiques de ce produit.
                </div>
              </TabsContent>
              <TabsContent value="care" className="mt-4">
                <div className="text-stone-600 text-sm space-y-2" dangerouslySetInnerHTML={{ __html: product.care.replace(/<br>/g, '<br class="block mb-2">') }} />
              </TabsContent>
            </Tabs>
          </div>
        </div>
        ...
        <section className="bg-beige-50 py-16">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-8">
              <h2 className="font-serif text-2xl md:text-3xl text-stone-800">Vous pourriez aussi aimer</h2>
                ...
                <Link to={`/products/${product.id}`} key={product.id} className="group">
                  <Card className="border-none shadow-sm overflow-hidden hover-scale">
                    ...
                    <CardContent className="p-4">
                      ...
                      <p className="text-olive-700 font-medium">{product.price} €</p>
                    </CardContent>
                  </Card>
                </Link>
              ))}
