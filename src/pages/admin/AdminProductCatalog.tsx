                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        {selectedProduct.care ||
                          "Aucune instruction d'entretien disponible"}
                      </p>
                    </div>
                  </TabsContent>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {selectedProduct.color || 'Non spécifié'}
                              </p>
                            </div>
                          </div>
                        </CardContent>
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {selectedProduct.weight_grams
                                  ? `${selectedProduct.weight_grams}g`
                                  : 'Non spécifié'}
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between py-2 border-b">
                          ...
                          <span className="font-mono text-xs">
                            {selectedProduct.slug || 'Non défini'}
                          </span>
                        </div>
                        <div className="flex justify-between py-2 border-b">
                  ...
                  <TabsContent value="artisan" className="mt-4 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="bg-muted/50 rounded-lg p-4">
                        <p className="text-muted-foreground leading-relaxed whitespace-pre-line">
                          {selectedProduct.artisan_story ||
                            "Aucune histoire d'artisan disponible. L'histoire de l'artisan permet de raconter le parcours, les techniques et la passion qui donnent vie à chaque création artisanale."}
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="text-center p-3 bg-muted rounded-lg">
                            <p className="text-2xl font-bold">
                              {selectedProduct.min_stock_level ?? 5}
                            </p>
                            <p className="text-xs text-muted-foreground">
                              Stock minimum
                            </p>
            ...
            <div key={product.id} className="mb-8 pb-8 border-b last:border-0">
              ...
              <div className="mt-2 grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <br />
                  <strong>Matériau:</strong> {product.material || 'N/A'}
                  <br />
                  <strong>Couleur:</strong> {product.color || 'N/A'}
                  <br />
