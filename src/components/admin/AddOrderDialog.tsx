...
export const AddOrderDialog = ({ onOrderAdded }: AddOrderDialogProps) => {
  ...
  const updateOrderItem = (index: number, field: keyof OrderItem, value: string | number) => {
    ...
    if (field === 'product_id') {
      ...
      updatedItems[index].total_price = (value as number) * updatedItems[index].quantity;
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Button type="button" variant="outline" onClick={addOrderItem} className="gap-2">
            ...
            {orderItems.length === 0 ? (
              ...
              <div className="space-y-3">
                {orderItems.map((item, index) => (
                  <div key={index} className="flex items-center space-x-4 p-4 border rounded-lg bg-stone-50">
