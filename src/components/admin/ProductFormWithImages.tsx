...
export const ProductFormWithImages = ({
  onProductAdded,
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-[95vw] max-w-6xl h-[95vh] flex flex-col p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-4 border-b flex-shrink-0 bg-background">
          ...
          <DialogDescription>
            Ajoutez un nouveau produit avec ses images et informations
            détaillées.
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange('weight_grams', e.target.value)
                      }
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleInputChange('artisan_story', e.target.value)
                    }
                    rows={4}
                  />
                </div>
                ...
                <div className="flex flex-wrap gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange('is_new', checked)
                      }
                    />
