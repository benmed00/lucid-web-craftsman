...
>(
  (
    { productId, className, size = 'md', variant = 'ghost', showText = false },
    ref
  ) => {
    ...
    return (
      <TooltipWrapper content={tooltipText} disabled={showText}>
        <Button
          ref={ref}
          variant={variant}
        ...
        >
          ...
          />
          {showText && <span className="ml-2">{tooltipText}</span>}
        </Button>
      </TooltipWrapper>
    );
  }
