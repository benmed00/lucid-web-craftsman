...
function main() {
  ...
  const doc = {
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'GENERATED by scripts/openapi-edge-functions.mjs. Do not hand-edit; run npm run openapi:edge-functions. Optional per-function detail: supabase/functions/<name>/openapi.fragment.json',
    },
    servers: [
      {
