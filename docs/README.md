...
| [**TECH_DEBT.md**](./TECH_DEBT.md)                                         | ESLint carve-outs (`no-restricted-imports`), **`react-hooks/exhaustive-deps`** policy, Deno **`ban-ts-comment`** rationale — shrink with tickets, do not expand silently.                                                                                      |
